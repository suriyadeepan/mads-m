...
\begin{figure}[h]{} 
	\label{fig:em}
  \begin{center}
		\includegraphics[scale=0.15, natwidth=0.38\textwidth]{em}
  \end{center}
...
\begin{figure}[h]{} 
	\label{fig:ev}
  \begin{center}
		\includegraphics[scale=0.15, natwidth=0.38\textwidth]{ev}
  \end{center}
...
\begin{figure}[h]{} 
	\label{fig:prm}
  \begin{center}
    \includegraphics[scale=0.15, natwidth=0.38\textwidth]{prm}
  \end{center}
...
\begin{figure}[h]{} 
	\label{fig:prv}
  \begin{center}
		\includegraphics[scale=0.15, natwidth=0.38\textwidth]{prv}
  \end{center}
...
\begin{figure}[h]{} 
	\label{fig:pm}
  \begin{center}
		\includegraphics[scale=0.15, natwidth=0.38\textwidth]{pm}
  \end{center}
...
\begin{figure}[h]{} 
	\label{fig:pv}
  \begin{center}
		\includegraphics[scale=0.15, natwidth=0.38\textwidth]{pv}
  \end{center}
...
\begin{figure}[h]{} 
	\label{fig:cm}
  \begin{center}
		\includegraphics[scale=0.15, natwidth=0.38\textwidth]{cm}
  \end{center}
...
\begin{figure}[h]{} 
	\label{fig:ccm}
  \begin{center}
		\includegraphics[scale=0.15, natwidth=0.38\textwidth]{ccm}
  \end{center}
...
%\begin{figure*}
%	\subfigure[]{\includegraphics[width=0.4\textwidth]{cm}\label{fig:cmg}}\par\vfill
%	\subfigure[]{\includegraphics[width=0.4\textwidth]{ccm}\label{fig:ccmg}}
%	\caption{Control Packets Comparison}
%\end{figure*}
%
%\begin{figure*}
%	\subfigure[]{\includegraphics[width=0.4\textwidth]{em}\label{fig:emg}}\par\vfill
%	\subfigure[]{\includegraphics[width=0.4\textwidth]{ev}\label{fig:evg}}
%	\caption{Energy Comparison}
%\end{figure*}
%
%\begin{figure*}
%	\subfigure[]{\includegraphics[width=0.4\textwidth]{pm}\label{fig:pmg}}\par\vfill
%	\subfigure[]{\includegraphics[width=0.4\textwidth]{pv}\label{fig:pvg}}
%	\caption{Energy Comparison}
%\end{figure*}
%
%
%\begin{figure*}
%	\subfigure[]{\includegraphics[width=0.4\textwidth]{prm}\label{fig:prmg}}\par\vfill
%	\subfigure[]{\includegraphics[width=0.4\textwidth]{prv}\label{fig:prvg}}
%	\caption{Energy Comparison}
%\end{figure*}
